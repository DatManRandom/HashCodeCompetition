...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Integer simulation_time=Integer.parseInt(first_line[0]),
                intersictions=Integer.parseInt(first_line[1]),
                streets=Integer.parseInt(first_line[2]),
                cars=Integer.parseInt(first_line[3]),
                bouns=Integer.parseInt(first_line[4]);
        Main.Set(simulation_time,intersictions,streets,cars,bouns);
        int counter=0;
